...
render() {
  difference() {
    difference() {
      ...
      translate(v=[-INNER_WALL_RADIUS - WALL_THICKNESS, -INNER_WALL_RADIUS - WALL_THICKNESS, RIM_LENGTH + WALL_THICKNESS]) {
        // Leave the Rim and the Ceiling in tact
        cube(
          size=[
    ...
    translate(v=[0, -INNER_WALL_RADIUS - WALL_THICKNESS, RIM_LENGTH + WALL_THICKNESS]) {
      // Leave the Rim and the Ceiling in tact
      cube(
        size=[
          INNER_WALL_RADIUS + WALL_THICKNESS,
