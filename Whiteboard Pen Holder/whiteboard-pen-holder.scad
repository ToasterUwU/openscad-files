...
/* [Pen Hole Dimensions] */
PEN_WIDTH = 17; // .1
PEN_HOLE_TOLERANCE = 1.00; // .1
PEN_HOLE_DEPTH = 70; // .1
PEN_HOLE_BACKWALL_THICKNESS = 5; // .1
PEN_HOLE_SPACER_WIDTH = 13; // .1
...
TISSUE_BOX_HEIGHT = 93; // .1
TISSUE_BOX_WIDTH = 40; // .1
TISSUE_BOX_WALL_THICKNESS = 2; // .1
...
render() {
  difference() {
    ...
    translate(
      ...
      rotate(a=90, v=[1, 0, 0]) {
        // Flop the Cylinders over
        for (xi = [0:1:PEN_HOLE_ROWS - 1]) {
          // Make 3 rows
          for (yi = [0:1:PEN_HOLE_COLUMS - 1]) {
            // Make 3 colums
